...
var tipuesearch_build = {"building": [
     {"title": "Byrne House", "text": "", "tags": " ", "url": "javascript:showtooltip('#byrne');"},
      
     {"title": "Cannavino Library", "text": "", "tags": "coffee", "url": "javascript:showtooltip('#library');"},
     
     {"title": "Champagnat Hall", "text": "", "tags": "housing, freshmen, freshman, champ", "url": "javascript:showtooltip('#ch');"},
     ...
     {"title": "Dyson Center", "text": "", "tags": "food, grub, coffee", "url": "javascript:showtooltip('#dy');"},

     {"title": "Fern Tor", "text": "", "tags": "", "url": "javascript:showtooltip('#fern');"},
     
     {"title": "Fontaine Hall", "text": "", "tags": "", "url": "javascript:showtooltip('#fn');"},
     
     {"title": "Foy Townhouses", "text": "", "tags": "housing", "url": "javascript:showtooltip('#foy');"},
     {"title": "Fulton Street Townhouses (Lower)", "text": "", "tags": "New Fulton, Lower Fulton, housing", "url": "javascript:showtooltip('#lf');"},
     {"title": "Fulton Street Townhouses (Upper)", "text": "", "tags": "Upper Fulton, housing", "url": "javascript:showtooltip('#uf');"},
     
     {"title": "Gartland Athletic Field", "text": "", "tags": "Softball, Rugby, North Field", "url": "javascript:showtooltip('#sball');"},
     
     {"title": "Greystone Hall", "text": "", "tags": "", "url": "javascript:showtooltip('#gs');"},
...
var tipuesearch = {"dept": [     
     {"title": "Campus Ministry", "text": "Byrne House", "tags": " ", "url": "javascript:showtooltip('#byrne');"},
      
     {"title": "Academic Learning Center", "text": "Cannavino Library", "tags": "", "url": "javascript:showtooltip('#library');"},
     {"title": "Academic Technology", "text": "Cannavino Library", "tags": "", "url": "javascript:showtooltip('#library');"},
     {"title": "Center for Career Services", "text": "Cannavino Library", "tags": "", "url": "javascript:showtooltip('#library');"},     
     {"title": "Center for Multicultural Affairs/HEOP", "text": "Cannavino Library", "tags": "", "url": "javascript:showtooltip('#library');"},
     {"title": "Library Brew", "text": "Cannavino Library", "tags": "food, grub, coffee", "url": "javascript:showtooltip('#library');"},
     {"title": "Weiss Language Center", "text": "Cannavino Library", "tags": "", "url": "javascript:showtooltip('#library');"},
     ...
     {"title": "Advising and Academic Services", "text": "Donnelly Hall", "tags": "", "url": "javascript:showtooltip('#dn');"},     
     {"title": "Business and Financial Affairs", "text": "Donnelly Hall", "tags": "", "url": "javascript:showtooltip('#dn');"},
     {"title": "Donnelly Cafe", "text": "Donnelly Hall", "tags": "food, grub, coffee", "url": "javascript:showtooltip('#dn');"},
     {"title": "Help Desk", "text": "Donnelly Hall", "tags": "", "url": "javascript:showtooltip('#dn');"},
     {"title": "Information Technology", "text": "Donnelly Hall", "tags": "IT", "url": "javascript:showtooltip('#dn');"},
     {"title": "Registrar", "text": "Donnelly Hall", "tags": "", "url": "javascript:showtooltip('#dn');"},
     {"title": "ResNet (Client Technologies)", "text": "Donnelly Hall", "tags": "", "url": "javascript:showtooltip('#dn');"},
     ...
     {"title": "Alumni Relations", "text": "Fontaine Hall", "tags": "", "url": "javascript:showtooltip('#fn');"},
     {"title": "Center for Civic Engagement and Leadership", "text": "Fontaine Hall", "tags": "", "url": "javascript:showtooltip('#fn');"},
     {"title": "Hudson River Valley Institute", "text": "Fontaine Hall", "tags": "", "url": "javascript:showtooltip('#fn');"},
     {"title": "Office of College Advancement", "text": "Fontaine Hall", "tags": "", "url": "javascript:showtooltip('#fn');"},
     {"title": "Public Affairs", "text": "", "tags": "Fontaine Hall", "url": "javascript:showtooltip('#fn');"},
     {"title": "School of Liberal Arts", "text": "Fontaine Hall", "tags": "", "url": "javascript:showtooltip('#fn');"},
    ...
    // {"title": "Upperclass Residence", "text": "Fulton Street Townhouses (Upper)", "tags": "", "url": ""},
     ...
     {"title": "Office of the President", "text": "Greystone Hall", "tags": "president's office", "url": "javascript:showtooltip('#gs');"},
     {"title": "Office of the Executive Vice-President", "text": "Greystone Hall", "tags": "", "url": "javascript:showtooltip('#gs');"},
     
     {"title": "Center for Teaching Excellence", "text": "Hancock Center", "tags": "", "url": "javascript:showtooltip('#hc');"},
